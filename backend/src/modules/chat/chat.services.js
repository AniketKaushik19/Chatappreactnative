...
export const getMessage=async(userId1, userId2 , limit=50, cursor=null)=>{
    const where={
        OR:[
    ...
    const results=hasMore ? message.slice(0,limit) : messages;
    return {
...
export const markMessageAsRead=async(userId , senderId)=>{
