...
-- CreateIndex
CREATE INDEX "FriendRequest_receivedId_idx" ON "FriendRequest"("receivedId");
...
-- AddForeignKey
ALTER TABLE "FriendRequest" ADD CONSTRAINT "FriendRequest_receivedId_fkey" FOREIGN KEY ("receivedId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
